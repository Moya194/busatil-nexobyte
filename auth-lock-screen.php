...
<!-- Mirrored from themes.getappui.com/collab/unikit/default/auth-lock-screen.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Mar 2025 06:17:41 GMT -->
<head>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="text-center text-muted">
                                    <p class="mb-1">Not you ? return  <a href="auth-register.php" class="text-primary ms-2">Sign in here</a></p>
                                </div>
                            </div><!--end card-body-->
